...
const es: Dict = {
  ...
  enfoque: {
    ...
    phrase: (
      <>
        Conocimiento <span style={{ color: "#c4a875" }}>+</span> 25 años de experiencia en RRHH y entornos internacionales{" "}
        <span style={{ color: "#c4a875" }}>+</span> tecnología <span style={{ color: "#c4a875" }}>+</span> investigación{" "}
        <span style={{ color: "#c4a875" }}>=</span> soluciones «ad hoc» con impacto real en el negocio.
      </>
    ),
  },
  contacto: {
...
const en: Dict = {
  ...
  enfoque: {
    ...
    phrase: (
      <>
        Knowledge <span style={{ color: "#c4a875" }}>+</span> 25 years of HR experience in international environments{" "}
        <span style={{ color: "#c4a875" }}>+</span> technology <span style={{ color: "#c4a875" }}>+</span> research{" "}
        <span style={{ color: "#c4a875" }}>=</span> bespoke solutions with real business impact.
      </>
    ),
  },
  contacto: {
